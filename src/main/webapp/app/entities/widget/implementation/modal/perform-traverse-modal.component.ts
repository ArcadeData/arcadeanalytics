...
@Component({
    selector: 'jhi-perform-traverse-popup',
    templateUrl: './perform-traverse-modal.component.html'
})
export class PerformTraverseModalComponent implements OnInit, OnDestroy {
