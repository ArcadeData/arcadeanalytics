...
import com.arcadeanalytics.config.Constants;
...
public class AccountResourceIntTest {
    ...
    @Mock
    private ArcadeUserRepository mocArcadeUserRepository;
    ...
    public void setup() {
        ...
        AccountResource accountResource =
            new AccountResource(userRepository, arcadeUserRepository, userService, mockMailService, environmentService, contractMapper);

        AccountResource accountUserMockResource =
            new AccountResource(userRepository, mocArcadeUserRepository, mockUserService, mockMailService, environmentService, contractMapper);
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        ArcadeUser arcadeUser = new ArcadeUser()
            .company(new Company().contract(contract))
            .user(user);

        when(mockUserService.getUserWithAuthorities()).thenReturn(Optional.of(user));
        when(mocArcadeUserRepository.findByUserLogin("test")).thenReturn(Optional.of(arcadeUser));
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.contract.type").value(ContractType.FREE.name()));
    }
