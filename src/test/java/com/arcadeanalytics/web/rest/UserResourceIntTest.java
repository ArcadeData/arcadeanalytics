...
import com.arcadeanalytics.service.mapper.UserMapper;
...
public class UserResourceIntTest {
    ...
    public void createUser() throws Exception {
        ...
        int workspasceSizeBeforeCreate = workspaceRepository.findAll().size();
        int dashboardSizeBeforeCreate = dashboardRepository.findAll().size();
        ...
        managedUserVM.setContract(new ContractDTO());
        ...
        assertThat(workspaceRepository.findAll()).hasSize(workspasceSizeBeforeCreate + 1);
        assertThat(dashboardRepository.findAll()).hasSize(workspasceSizeBeforeCreate + 1);
    }
    ...
    public void updateUser() throws Exception {
        ...
        managedUserVM.setContractType(ContractType.GOLD.name());
    ...
    public void deleteUser() throws Exception {
        ...
        environmentService.createBaseEnvironment(user, ContractType.FREE);
