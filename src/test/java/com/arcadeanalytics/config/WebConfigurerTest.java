...
//        env.setActiveProfiles(JHipsterConstants.SPRING_PROFILE_PRODUCTION);
//        UndertowEmbeddedServletContainerFactory sshContainer = new UndertowEmbeddedServletContainerFactory();
//        webConfigurer.customize(sshContainer);
//        assertThat(sshContainer.getMimeMappings().get("abs")).isEqualTo("audio/x-mpeg");
//        assertThat(sshContainer.getMimeMappings().get("html")).isEqualTo("text/html;charset=utf-8");
//        assertThat(sshContainer.getMimeMappings().get("json")).isEqualTo("text/html;charset=utf-8");
//        if (sshContainer.getDocumentRoot() != null) {
//            assertThat(sshContainer.getDocumentRoot().getPath()).isEqualTo(FilenameUtils.separatorsToSystem("build/www"));
//        }
//
//        Builder builder = Undertow.builder();
//        sshContainer.getBuilderCustomizers().forEach(c -> c.customize(builder));
